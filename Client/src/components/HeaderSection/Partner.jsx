...
//     <div className="bg-gradient-to-b from-blue-50 to-white min-h-screen">
//       {/* HEADER */}
//      <header className="bg-gradient-to-r from-[#121212] to-[#1E3A8A] text-white text-center py-16 shadow-md flex flex-col items-center justify-center min-h-[60vh]">
//   <h1 className="text-4xl md:text-5xl font-bold mb-4">
//     Nos Partenaires et Supporters
//   </h1>
//   <p className="max-w-2xl mx-auto text-lg opacity-90">
//     Découvrez les entreprises, associations et passionnés qui soutiennent le <strong>Jorfof Club</strong> dans son ambition : <em>Toujours Prêt à Gagner !</em>
//   </p>
// </header>
...
//       <div className="container mx-auto px-4 md:px-8 max-w-6xl py-16">
//         <h2 className="text-3xl md:text-4xl font-bold text-center text-[#12138B] mb-12">
//           Pourquoi devenir partenaire du Jorfof Club ?
//         </h2>

//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//           {[
//             {
//               title: 'Visibilité locale et régionale',
//               description: 'Associez votre marque à un club dynamique et gagnez en visibilité lors des matchs et événements.',
//               icon: '📣',
//             },
//             {
//               title: 'Esprit d’équipe et valeurs sportives',
//               description: 'Partagez les valeurs du sport : respect, dépassement de soi et solidarité.',
//               icon: '🏀',
//             },
//             {
//               title: 'Événements exclusifs',
//               description: 'Invitations à nos matchs, tournois et rencontres avec les joueurs.',
//               icon: '🎟️',
//             },
//             {
//               title: 'Partenariat communautaire',
//               description: 'Soutenez la jeunesse locale et participez à nos actions sportives et sociales.',
//               icon: '🤝',
//             },
//             {
//               title: 'Communication partagée',
//               description: 'Mise en avant sur nos réseaux sociaux, maillots et supports officiels.',
//               icon: '📱',
//             },
//             {
//               title: 'Croissance mutuelle',
//               description: 'Développons ensemble une collaboration gagnant-gagnant entre sport et entreprise.',
//               icon: '💪',
//             },
//           ].map((item, index) => (
//             <div key={index} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition transform hover:-translate-y-1">
...
//         <div className="bg-white p-8 md:p-12 rounded-2xl shadow-xl">
//           <h2 className="text-3xl md:text-4xl font-bold text-[#12138B] text-center mb-10">
//             Rejoignez l’aventure Jorfof Club
//           </h2>
//           <p className="text-lg text-gray-700 leading-relaxed mb-10 text-center">
//             Devenez partenaire, supporter ou membre officiel du club.  
//             Ensemble, faisons grandir le basket et nos ambitions !
//           </p>

//           {showSuccess && (
//             <div className="bg-green-50 border-l-4 border-green-500 p-4 mb-8 rounded-md text-green-700">
//               Votre demande a été envoyée avec succès ! Merci pour votre soutien 💙
//             </div>
//           )}
...
//                   value={form.role}
//                   onChange={handleChange}
//                   className={`w-full p-3 border rounded-lg ${formErrors.role ? 'border-red-500' : 'border-gray-300'}`}
//                 >
...
//                   value={form.first_name}
//                   onChange={handleChange}
//                   className={`w-full p-3 border rounded-lg ${formErrors.first_name ? 'border-red-500' : 'border-gray-300'}`}
...
//                   value={form.last_name}
//                   onChange={handleChange}
//                   className={`w-full p-3 border rounded-lg ${formErrors.last_name ? 'border-red-500' : 'border-gray-300'}`}
...
//                 onChange={handleChange}
//                 rows="6"
//                 className={`w-full p-3 border rounded-lg ${formErrors.message ? 'border-red-500' : 'border-gray-300'}`}
//                 placeholder="Parlez-nous de votre intérêt pour le club ou de votre proposition."
//               ></textarea>
//             </div>
...
//                 className="mr-2"
//               />
//               <label>J’accepte les conditions générales du Jorfof Club *</label>
//             </div>
...
//                 type="submit"
//                 disabled={isSubmitting}
//                 className="bg-[#12138B] text-white px-10 py-4 rounded-lg font-medium text-lg hover:bg-blue-700 transition-all transform hover:scale-105 shadow-md"
//               >
...
//         <h2 className="text-3xl md:text-4xl font-bold mb-6">Prêt à rejoindre l’équipe ?</h2>
//         <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
//           Soutenez le <strong>Jorfof Club</strong> et participez à notre passion commune : le basket-ball.  
//           Ensemble, faisons vibrer les terrains !
//         </p>
//         <button
//           onClick={() => document.getElementById('partnerForm').scrollIntoView({ behavior: 'smooth' })}
...
const Partner = () => {
  const [form, setForm] = useState({
    ...
    message: '',
    accept_terms: false,
    logo: null, // 👈 pour un upload image/logo
  });
  ...
  // ☁️ Upload Cloudinary (image/logo)
  const uploadToCloudinary = async (file) => {
    const url = `https://api.cloudinary.com/v1_1/${CONFIG.CLOUDINARY_NAME}/upload`;
    ...
    return result.secure_url; // ✅ URL Cloudinary
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(CONFIG.API_PARTNER_CREATE, {
        method: 'POST',
      ...
      alert("Impossible d'envoyer la demande. Réessayez plus tard.");
    } finally {
      setIsSubmitting(false);
    }
  };
  ...
  return (
    <div className="bg-gradient-to-b from-blue-50 to-white min-h-screen">
      <header className="bg-gradient-to-r from-[#121212] to-[#1E3A8A] text-white text-center py-16 shadow-md">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">
          Devenez partenaire du Jorfof Club
        </h1>
        <p className="max-w-2xl mx-auto text-lg opacity-90">
          Soutenez notre club et bénéficiez d’une visibilité unique tout en partageant les valeurs du sport.
        </p>
      </header>

      <div className="container mx-auto px-4 md:px-8 max-w-4xl py-16">
        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-lg space-y-6">
          <h2 className="text-2xl font-bold text-[#12138B] text-center mb-6">
            Formulaire de partenariat
          </h2>

          {showSuccess && (
            <div className="bg-green-50 border-l-4 border-green-500 p-4 text-green-700 rounded-md">
              🎉 Votre demande a été envoyée avec succès !
            </div>
          )}

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <input name="first_name" placeholder="Nom *" value={form.first_name} onChange={handleChange} className="p-3 border rounded-lg" />
            <input name="last_name" placeholder="Prénom *" value={form.last_name} onChange={handleChange} className="p-3 border rounded-lg" />
            <input type="email" name="email" placeholder="Email *" value={form.email} onChange={handleChange} className="p-3 border rounded-lg" />
            <input name="phone" placeholder="Téléphone *" value={form.phone} onChange={handleChange} className="p-3 border rounded-lg" />
            <input name="organisation" placeholder="Organisation (facultatif)" value={form.organisation} onChange={handleChange} className="p-3 border rounded-lg" />
            <input name="website_url" placeholder="Site web (facultatif)" value={form.website_url} onChange={handleChange} className="p-3 border rounded-lg" />
            <input type="file" name="logo" accept="image/*" onChange={handleChange} className="p-3 border rounded-lg" />
          </div>

          <textarea name="message" placeholder="Votre message *" value={form.message} onChange={handleChange} rows="5" className="w-full p-3 border rounded-lg"></textarea>
          ...
          <div className="text-center">
            <button type="submit" disabled={isSubmitting} className="bg-[#12138B] text-white px-8 py-3 rounded-lg font-medium hover:bg-blue-700 transition">
              {isSubmitting ? 'Envoi en cours...' : 'Envoyer ma demande'}
            </button>
          </div>
        </form>
