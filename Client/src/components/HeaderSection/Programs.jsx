...
//       <div className="relative bg-gradient-to-r from-orange-500/10 via-blue-500/10 to-orange-500/10 backdrop-blur-xl border-t-2 border-orange-500/30 py-16 text-white text-center overflow-hidden">
//         {/* Effets de fond */}
