...
import React, { useEffect, useState } from "react";
import { User, Sparkles, Quote, Calendar, Zap } from "lucide-react";
...
const MotPresident = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0e27] relative overflow-hidden w-full">
      ...
      {/* 🧠 CONTENU */}
      <div className="relative container mx-auto px-6 lg:px-20 pb-20">
        {loading ? (
          // 🌀 Loader
          ...
          // ⚠️ Erreur
          <div className="max-w-4xl mx-auto text-center py-20 bg-red-500/10 backdrop-blur-xl rounded-3xl shadow-2xl border-2 border-red-500/30 px-4">
          ...
          // ✅ Message affiché
          <div className="relative bg-[#0f1729]/80 backdrop-blur-xl border-2 border-orange-500/30 rounded-3xl overflow-hidden shadow-2xl">
            {/* Image */}
            <div className="relative h-96 w-full">
              ...
              <div className="absolute top-6 right-6 bg-blue-500/20 px-4 py-2 rounded-full border border-blue-400/30 text-white text-sm font-semibold flex items-center gap-2">
            ...
            <div className="p-8 lg:p-12">
              ...
              <div className="w-28 h-1 bg-gradient-to-r from-orange-500 via-blue-500 to-transparent rounded-full mb-8"></div>

              <p className="text-gray-300 text-lg leading-relaxed mb-10 whitespace-pre-line">
                {motPresident[`description_${i18n.language}`] ||
                  motPresident.description_fr}
              </p>
      ...
      <div className="relative py-12">
        <div className="container mx-auto px-6 lg:px-20">
          <div className="bg-gradient-to-r from-orange-500/10 via-blue-500/10 to-orange-500/10 backdrop-blur-xl border-2 border-orange-500/30 rounded-3xl p-12 text-center shadow-2xl">
