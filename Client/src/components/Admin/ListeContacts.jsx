            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex items-center space-x-4 mt-4 md:mt-0">
                <span className="text-sm text-gray-300">
                  {filteredContacts.length} {filteredContacts.length > 1 ? 'messages' : 'message'}
                </span>
                <button 
          ...
          <div className="px-6 py-4">
            {sortedContacts.length === 0 ? (
              <div className="text-center py-16">
                ...
                <h3 className="mt-2 text-lg font-medium text-gray-900">Aucun message trouvé</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {sortedContacts.map((contact) => (
                  <div key={contact.id} className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                    <div className="p-5">
                      ...
                      <div className="flex justify-end mt-4 pt-3 border-t border-gray-100">
                        <button
                          ...
                          onClick={() => {
                            // Fonction pour répondre au contact (à implémenter)
