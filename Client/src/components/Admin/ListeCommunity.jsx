...
const ListePostulantsCommunity = () => {
  ...
  const filteredPostulants = postulants.filter((p) =>
    ...
    safeString(p.message).includes(searchTerm.toLowerCase())
  );

  const sortedPostulants = [...filteredPostulants].sort((a, b) => {
    if (sortOrder === 'newest') {
...
export default ListePostulantsCommunity;