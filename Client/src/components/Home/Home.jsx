...
const Home = () => {
  ...
  // Composant pour les titres de section cliquables
  const SectionTitle = ({ icon: Icon, title, path, gradient, borderColor }) => (
    <button
      onClick={() => navigate(path)}
      className="group flex items-center gap-4 mb-8 cursor-pointer hover:scale-105 transition-transform duration-300"
    >
      <div className={`w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br ${gradient} rounded-xl flex items-center justify-center shadow-xl group-hover:shadow-2xl transition-shadow`}>
        <Icon className="w-6 h-6 md:w-7 md:h-7 text-white" />
      </div>
      <div>
        <div className="flex items-center gap-2">
          <h2 className="text-2xl md:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-orange-400 to-white group-hover:via-orange-300 transition-all">
            {title}
          </h2>
          <ArrowRight className="w-5 h-5 md:w-6 md:h-6 text-orange-400 group-hover:translate-x-2 transition-transform" />
        </div>
        <div className={`w-24 h-1 bg-gradient-to-r ${borderColor} to-transparent rounded-full mt-2`}></div>
      </div>
    </button>
  );
        ...
        <div className="relative w-full py-8 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="relative bg-[#0f1729]/90 backdrop-blur-xl rounded-3xl overflow-hidden border-2 border-orange-500/30 hover:border-orange-500/60 shadow-2xl transition-all">
                <div className="relative">
                  {latest_mot_president[0].image_url && (
                    <>
                      <img
                  ...
                  <div className="absolute top-6 left-6 md:top-8 md:left-8">
                    <div className="inline-flex items-center gap-3 bg-orange-500/20 backdrop-blur-sm border border-orange-500/40 px-4 py-2 rounded-full group-hover:bg-orange-500/30 transition-all">
                      <Quote className="w-4 h-4 text-orange-400" />
                      <span className="text-orange-300 text-sm font-bold uppercase tracking-wide">
                        {t("home.president_message")}
                      </span>
                  ...
                  <div className="absolute bottom-8 left-8 md:left-12 right-8 md:right-12 flex items-center justify-between">
                    <div>
                      <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-white mb-4 leading-tight drop-shadow-2xl">
                        {getLocalized(latest_mot_president[0], "title")}
                      </h2>
                    ...
                    <ArrowRight className="w-8 h-8 text-orange-400 group-hover:translate-x-2 transition-transform hidden md:block" />
                  </div>
                </div>
